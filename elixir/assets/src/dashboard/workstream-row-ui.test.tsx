...
describe("workstream row actions", () => {
  ...
  it("shows child target context only when repo or base branch differs", () => {
    ...
    const sameRepoHtml = renderSlice(detail, { id: "slice-local", work_request_id: "wr-primary", title: "Local slice", base_branch: "main" }, sameRepoPackage);
    const branchOnlyHtml = renderSlice(detail, { id: "slice-branch", work_request_id: "wr-primary", title: "Branch slice", base_branch: "release" }, branchOnlyPackage);
    const crossRepoHtml = renderSlice(detail, { id: "slice-cross", work_request_id: "wr-primary", title: "Cross-repo slice", base_branch: "release" }, crossRepoPackage);
...
function renderSlice(detail: WorkRequestDetail, slice: WorkRequestPackage, pkg: WorkPackageCard) {
