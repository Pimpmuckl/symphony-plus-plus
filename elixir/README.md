...
Normal dispatch responses do not include a private handoff path, helper
command, or secret-retrieval metadata.
...
- `server.port` or CLI `--port` enables the optional Phoenix dashboard and JSON API at
