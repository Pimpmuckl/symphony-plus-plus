...
Assert-True (@($coldSmoke.recovery | Where-Object { $_.mode -like "*ambiguous_tool_batch" -and $_.tools_list -eq 2 -and $_.mutations -eq 1 }).Count -eq 2) "Node and PowerShell fallback bridges must not replay a batch containing a mutating tool call"
