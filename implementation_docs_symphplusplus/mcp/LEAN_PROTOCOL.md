...
- `architect` exposes the architect claim plus every implemented architect
  operation. The three unwired Phase 7 stubs are omitted.
...
- `full` and the default retain complete legacy discovery for compatibility and
  diagnostics.
...
the full/default set was selectable on the first list.
...
| full | 79 | 55,432 | 13,858 | 79 | 55,432 | 13,858 |
| default | 79 | 55,432 | 13,858 | 79 | 55,432 | 13,858 |
